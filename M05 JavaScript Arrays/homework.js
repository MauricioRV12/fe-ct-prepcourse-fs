...
function devolverUltimoElemento(array) {
   ...
   // Tu código:
   return array [array.length - 1]; // devuelve el tamaño o numero de elementos del array menos 1, asi se accede y devuelve el ultimo elemento
} 
...
function dePalabrasAFrase(palabras) {
   ...
   // metodo 2, con logica de programacion
   // let res = "";
   // for (let i = 0; i< palabras.length; i++) {
   //  if (i+1 === palabras.length) res = res+palabras[i]
   //  else res=res+ palabras[i] + " ";
